...
app.use(
  cors({
    origin: [
      "https://www.velki123live.com.co",
      "https://www.winpub.co",
      "https://www.winpbu.com.co",
      ...
      "http://localhost:5173",
      "http://localhost:5174", // keep localhost for dev
    ],
...
async function run() {
  try {
    ...
    const superAgentswhatsappLinksCollection = client
      .db("velki")
      .collection("super-agents-whatsapp-links");
